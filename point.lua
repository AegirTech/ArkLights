...
point = {
    ...
    循心taglist = {"欣慰","期冀","紧张","狂喜","激动","烦恼","警惕","无畏","愤慨","暴怒","凄婉","忧惧","悔恨","悲恸","悲愤","顾虑","畏缩","惊恐","敬畏","懊恼"},
    循心tag = {
        ["欣慰"]={
        乐 = 2,
        怒 = 0,
    ...
    循心角色 = {"学生梅丽","香肠摊摊主","莱娜女士","咖啡店店长","可疑的市民","乐器行老板","艺术杂志编辑","神秘的术师","学生霍内斯","治安官菲施尔","小队长克斯汀","雕刻师","卖花人","“哈曼","珠宝店老板","音乐家舒曼","有嫌疑的术师","宪兵席美尔","学生布赫纳","学生林德纳","陌生男子","大学学生","莱辛","密使","米夏","金律法卫","大帝"},
    char2tag = {
        ["学生梅丽"] = {
        情绪 = "乐",
        欲望 = "尘俗",
    ...
    查访人物名 = {668,814,1749,884},
    循心 = "279|636|FF6801",
    循心2 = "208|616|B2A082", --测试用
    循心主页判断 = "1487|1018|548274", -- 用于判断
    空库存 = {671,536,900,616},
    密令查访解锁 = {317,872,518,945},
    查访完成 = "818|867|404040,1201|866|404040,1586|867|404040", -- 不判断密令，因为找不到点来判断
    密令查访 = "389|774|7A6A59",
    开始查访 = "417|971|202020",
    密令查访2 = "310|895|9A826C",
    密令查访范围 = {194,600,558,964},
    普通查访0 = "818|870|E5E5E5",
    普通查访0范围 = {637,800,1001,890},
    术法集谱 = "262|175|BFBFBF,1503|152|BFBFBF,1239|824|B3B4B4",
    乐曲提示 = "417|468|262626,1053|607|6B6B6B",
    心绪触动 = "841|596|947B62",
    心绪不符 = "860|603|676767",
    合成卡住 = "950|961|4C4C4C",
    普通查访1 = "1201|870|E5E5E5",
    普通查访1范围 = {1035,800,1388,890},
    普通查访2 = "1591|881|E5E5E5",
    普通查访2范围 = {1412,800,1766,890},
    构建法术 = "1885|976|EDEDED",
    新手教程 = "187|163|EAEAEA,208|162|2E2E2E",
    乐 = "696|733|AA7F66",
    怒 = "876|733|A65557",
    哀 = "1047|733|6E9BAA",
    惧 = "1220|733|829D8B",
    联结洞悉 = "1597|1008|121212",
    未联结 = "1603|982|434343",
    联结上一步 = "1359|985|EEEEEE", -- 用于判断
    欲念左 = "669|794|000000",
    欲念右 = "1256|794|000000",
    乐之章 = {142,239},
    乐之章2 = "141|226|E6E1DF",
    ...
    惧之章 = {143,619},
    惧之章2 = "141|607|E6E1DF",
    查访跳过黄 = "1576|948|958D85",
    查访跳过 = {1549,978}, -- 跳过剧情 选择心扉 复现场景
    查访页面判断 = "1616|881|0F0F0F,1829|813|0F0F0F,1439|793|0F0F0F",
    左下法术构建 = "215|960|D7D7D7",
    选择心扉 = "1525|985|EBEBEB", -- 用于判断
    复现选择 = "1582|961|282828", -- 用于判断
    复现场景 = "1560|943|993931",
    乐曲提示ocr范围 = {382,422,1549,612},
    左列乐章范围 = {30,181,167,824},
    乐曲总范围 = {401,76,1270,1066},
    -- 乐曲代币ocr范围 = {1138,969,1868,1044},
    -- 乐曲文字ocr范围 = {469,420,638,451},
    初始乐曲 = {537,335},
    左上返回 = "173|63|313131",
    -- 活动导航3 = "559|867|A19878",
    活动商店导航 = "237|785|6B3421",
    -- 每次商店颜色都不一样，故采用写死坐标方式，以下为1080p下测得数据
    商店OCR范围 = {1498, 226, 1901, 290}, -- 右上角截止时间
    -- 商店货币OCR范围 = {1610,31, 1855,74},
    -- 商品价格OCR范围 = {1216, 841,1548, 894},
    商店支付 = {1387, 837},
    商店顶栏 = {1161, 102},
    -- 商店标题返回 = "172|52|313131",
    -- 商店物品横间距 = 300,
    -- 商店物品纵间距 = 100,
    -- 商店初始物品 = {291, 440}, -- 第一行第一个
    商店最多 = {1601, 622},
